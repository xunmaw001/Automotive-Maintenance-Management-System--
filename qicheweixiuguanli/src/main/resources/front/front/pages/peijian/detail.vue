		...
		<view class="container">
			...
			<view class="detail-content">
				<view class="price detail-list-item priceFavor"
					...
					<view class="text" style="color: red;textAlign:left">
						<text style='font-size:20rpx'>¥</text><text style="font-weight:bold;font-size:50rpx">{{detail.peijianNewMoney}}</text><text style="font-size: 20rpx;color: #8799A3;margin-left: 10rpx;">
							<text v-if="detail.peijianOldMoney!=null">原价￥<text style="text-decoration:line-through">{{detail.peijianOldMoney}}</text></text>
                    	</text>
					</view>
				</view>
					...
					<view class="detail-list-item"
						...
						<view class="lable"
							...
							配件库存：</view>
						<view class="text" :style='{"color":"#06A9FF","textAlign":"center","fontSize":"24rpx"}'>
							{{detail.peijianKucunNumber}}</view>
					</view>
			...
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.peijianContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('peijian', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.peijianPhoto ? this.detail.peijianPhoto.split(",") : [];
			},
