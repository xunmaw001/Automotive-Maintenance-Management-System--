...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('weixiuxiangmuLiuyan', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.weixiuxiangmuLiuyanPhoto ? this.detail.weixiuxiangmuLiuyanPhoto.split(",") : [];
			},
