...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('peijianChuruInoutList', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.peijianChuruInoutListPhoto ? this.detail.peijianChuruInoutListPhoto.split(",") : [];
			},
