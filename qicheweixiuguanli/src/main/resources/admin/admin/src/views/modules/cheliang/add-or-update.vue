    ...
    <div class="addEdit-block">
        <el-form
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="车牌号" prop="cheliangUuidNumber">
                       <el-input v-model="ruleForm.cheliangUuidNumber"
                                 placeholder="车牌号" clearable  :readonly="ro.cheliangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="品牌" prop="cheliangTypes">
                        <el-select v-model="ruleForm.cheliangTypes" :disabled="ro.cheliangTypes" placeholder="请选择品牌">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="车型号" prop="cheliangXinghao">
                       <el-input v-model="ruleForm.cheliangXinghao"
                                 placeholder="车型号" clearable  :readonly="ro.cheliangXinghao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="颜色" prop="cheliangYanse">
                       <el-input v-model="ruleForm.cheliangYanse"
                                 placeholder="颜色" clearable  :readonly="ro.cheliangYanse"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="车辆详情" prop="newsContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.newsContent" label="车辆详情" prop="newsContent">
