    ...
    */
    ...
    public R save(@RequestBody CheliangEntity cheliang, HttpServletRequest request){
        ...
        Wrapper<CheliangEntity> queryWrapper = new EntityWrapper<CheliangEntity>()
            ...
            .eq("cheliang_xinghao", cheliang.getCheliangXinghao())
...
//                            cheliangEntity.setCheliangUuidNumber(data.get(0));                    //车牌号 要改的
//                            cheliangEntity.setCheliangTypes(Integer.valueOf(data.get(0)));   //品牌 要改的
//                            cheliangEntity.setCheliangPhoto("");//详情和图片
//                            cheliangEntity.setCheliangXinghao(data.get(0));                    //车型号 要改的
//                            cheliangEntity.setCheliangYanse(data.get(0));                    //颜色 要改的
//                            cheliangEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            cheliangEntity.setNewsContent("");//详情和图片
...
//                            cheliangEntity.setCreateTime(date);//时间
                        ...
                        if(cheliangEntities_cheliangUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [车牌号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
